...
echo "    cd backend && dotnet restore && dotnet run --launch-profile https"
echo "    ⚠️  Backend rodará em https://localhost:7197 (HTTPS necessário para WebRTC)"
echo ""
echo "  Terminal 2 - Frontend:"
echo "    cd frontend && npm install && npm run start"
echo ""
echo "Ou use:"
echo "  cd backend && ./clean-and-start.sh  (já configurado para HTTPS)"
